...
## Croatia and Italy 2026 Hotel Bookings

| Stop | Hotel to Book | Check-in | Check-out |
| --- | --- | --- | --- |
...
Note: All dates are now contiguous with no gaps. Same-day check-outs/check-ins (May 25 Verona→Tuscany, May 31 Tuscany→Rome) allow for daytime travel between locations.
