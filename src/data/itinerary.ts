...
const chinaDays: DayData[] = [
  ...
  // ===== QINGDAO (Day 10) =====
  {
    ...
    title: { en: 'Qingdao | Seaside Strolls & Architecture', zh: '青岛 | 海滨漫步与建筑' },
    region: 'qingdao',
    ...
    activities: {
      en: [
        '🚄 Early morning: High-speed rail Qufu → Qingdao (approx. 2 hours)',
        '🏨 Check-in near Wusi Square or Badaguan, store luggage',
        '🌊 Morning: Zhanqiao Pier to watch seagulls',
        '⛪ Visit St. Michael\'s Cathedral - Gothic architecture',
        '🏛️ Afternoon: Explore Badaguan - international architecture district',
        '🌊 Walk among red tiles, green trees, and azure seas',
        '🌅 Evening: May Fourth Square & Olympic Sailing Center',
        '🎆 Watch city light show',
        '🍺 Dinner: Seafood beer house experience',
      ],
      zh: [
        '🚄 清晨：高铁曲阜 → 青岛（约2小时）',
        '🏨 入住五四广场或八大关附近酒店，寄存行李',
  ...
  },
  {
    ...
    title: { en: 'Qingdao → Beijing | Flight Home', zh: '青岛 → 北京 | 返程回家' },
    region: 'travel',
    regionLabel: { en: 'Travel Day', zh: '旅行日' },
    mapQuery: 'Qingdao Railway Station, Shandong, China',
    accommodation: null,
    activities: {
      en: [
        '🌅 Morning: High-speed rail Qingdao → Beijing (~3-4 hours)',
        '🏨 Arrive Beijing, check-in or store luggage at hotel',
        '🍜 Light lunch near hotel',
        '📦 Final preparations, rest',
        '🚕 15:30-16:00: Leave for Beijing Capital Airport',
        '✈️ 19:50: Flight departs',
      ],
      zh: [
        '🌅 上午：高铁青岛 → 北京（约3-4小时）',
        '🏨 抵达北京，入住酒店或寄存行李',
