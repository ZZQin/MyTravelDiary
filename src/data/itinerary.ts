  ...
  },
  {
    ...
    activities: {
      en: [
        ...
        '💻 WORK CALL 16:00-18:00 — Find quiet spot at hotel or nearby café with WiFi',
      ...
      zh: [
        ...
        '🏛️ 可选：只走一小段城墙（视体力而定）',
        '☕ 在海边咖啡馆休息，看风景',
        '💻 工作电话 16:00-18:00 — 在酒店或附近咖啡馆找安静地方，确保有WiFi',
        '🍽️ 在海滨餐厅慢慢享用晚餐',
      ],
    },
  },
  ...
  // ===== SPLIT (Days 6-9) =====
  {
    ...
    activities: {
      en: [
        ...
        '💻 WORK CALL 15:00-17:00 — Hotel WiFi or nearby café with quiet corner',
      ...
      zh: [
        '🚌 乘巴士/自驾1.5–2小时到斯普利特',
        '🏨 入住靠近海滨长廊/戴克里先宫的住宿',
        '💻 工作电话 15:00-17:00 — 酒店WiFi或附近安静咖啡馆',
        '🚶 傍晚在海滨长廊轻松散步',
        '🍽️ 在当地小馆（konoba）用晚餐',
      ],
    },
  ...
  },
  {
    ...
    activities: {
      en: [
        ...
        '💻 WORK CALL 16:00-18:00 — Hotel WiFi or quiet café in Old Town',
      ...
      zh: [
        ...
        '☕ 在历史悠久的咖啡馆休息',
        '💻 工作电话 16:00-18:00 — 酒店WiFi或老城安静咖啡馆',
        '🌅 傍晚去海风琴和"向太阳致敬"看日落',
        '🍽️ 海边海鲜晚餐',
      ],
    },
  ...
  },
  {
    ...
    activities: {
      en: [
        ...
        '💻 WORK CALL 15:00-17:00 — Hotel WiFi or quiet spot at accommodation',
      ...
      zh: [
        ...
        '🏨 入住，与朋友会面',
        '💻 工作电话 15:00-17:00 — 酒店WiFi或住宿安静地方',
        '🏖️ 轻松海滩或参观 Nehaj 堡垒',
        '🍽️ 与朋友共进晚餐',
      ],
    },
  ...
  },
  {
    ...
    activities: {
      en: [
        ...
        '💻 WORK CALL 16:00-18:00 — Agriturismo WiFi or quiet spot',
      ],
      zh: [
        ...
        '💻 工作电话 16:00-18:00 — 乡村酒店WiFi或安静地方',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    activities: {
      en: [
        ...
        '💻 WORK CALL 15:00-17:00 — Take call from Pienza café or return to agriturismo',
      ...
      zh: [
        ...
        '💻 工作电话 15:00-17:00 — 在皮恩扎咖啡馆或返回乡村酒店',
  ...
  // ===== ROME (Days 25-29) =====
  {
    ...
    activities: {
      en: [
        ...
        '💻 WORK CALL 16:00-18:00 — Hotel WiFi or nearby café with quiet space',
      ...
      zh: [
        '🏛️ 参观斗兽场（选择相对轻松路线）',
        '📸 在观景点远眺古罗马广场',
        '💻 工作电话 16:00-18:00 — 酒店WiFi或附近安静咖啡馆',
        '🚕 建议打车往返并多安排休息',
        '🍽️ 酒店附近用晚餐',
      ],
    },
  ...
  },
  {
    ...
    activities: {
      en: [
        ...
        '💻 WORK CALL 15:00-17:00 — Hotel WiFi or café near Pantheon/Piazza Navona',
      ...
      zh: [
        ...
        '☕ 将步行路段分成多段，中间多休息',
        '💻 工作电话 15:00-17:00 — 酒店WiFi或万神殿/纳沃纳广场附近咖啡馆',
        '🚕 必要时乘坐出租车连接景点',
        '🍨 沿途吃冰淇淋',
      ],
    },
