...
const croatiaCategories: ActivityCategory[] = [
  {
    ...
    icon: '🏛️',
    items: [
      { en: 'Dubrovnik Old Town: UNESCO walled city, cable car to Mt. Srđ', zh: '杜布罗夫尼克老城：联合国世界文化遗产，缆车上 Srđ 山', image: 'https://source.unsplash.com/800x600/?dubrovnik,croatia,walls' },
      { en: 'Lokrum Island: Botanical gardens, peacocks, easy boardwalks', zh: '洛克鲁姆岛：植物园、孔雀、平缓木栈道', image: 'https://source.unsplash.com/800x600/?lokrum,island,croatia' },
      { en: 'Split: Diocletian\'s Palace, Riva promenade', zh: '斯普利特：戴克里先宫、海滨长廊', image: 'https://source.unsplash.com/800x600/?split,croatia,palace' },
      { en: 'Krka National Park: Waterfalls, boat rides, easy walks', zh: '克尔卡国家公园：瀑布、游船、轻松步行', image: 'https://source.unsplash.com/800x600/?krka,waterfall,croatia' },
      { en: 'Hvar Island: Harbor town, beaches, lavender fields', zh: '赫瓦尔岛：港口小镇、海滩、薰衣草田', image: 'https://source.unsplash.com/800x600/?hvar,island,croatia' },
      { en: 'Zadar: Sea Organ, Greeting to the Sun, Roman forum', zh: '扎达尔：海风琴、向太阳致敬、古罗马广场', image: 'https://source.unsplash.com/800x600/?zadar,croatia,sunset' },
      { en: 'Plitvice Lakes: UNESCO national park with lakes and waterfalls', zh: '普利特维采湖：联合国世界自然遗产，湖泊瀑布', image: 'https://source.unsplash.com/800x600/?plitvice,lakes,croatia' },
    ],
  },
  {
    ...
    icon: '🏛️',
    items: [
      { en: 'St. Mark\'s Square & Basilica: Heart of Venice', zh: '圣马可广场和大教堂：威尼斯的心脏', image: 'https://source.unsplash.com/800x600/?venice,san,marco' },
      { en: 'Rialto Bridge: Iconic crossing over Grand Canal', zh: '里亚托桥：大运河上的标志性建筑', image: 'https://source.unsplash.com/800x600/?rialto,bridge,venice' },
      { en: 'Grand Canal Vaporetto: Scenic water bus ride', zh: '大运河水上巴士：风景优美的水上交通', image: 'https://source.unsplash.com/800x600/?grand,canal,venice' },
      { en: 'Arena di Verona: Ancient Roman amphitheater', zh: '维罗纳竞技场：古罗马圆形剧场', image: 'https://source.unsplash.com/800x600/?verona,arena,italy' },
      { en: 'Juliet\'s House (Casa di Giulietta): Iconic balcony', zh: '朱丽叶之家（Casa di Giulietta）：经典阳台', image: 'https://source.unsplash.com/800x600/?juliet,house,verona' },
    ],
  },
  {
    ...
    icon: '🍷',
    items: [
      { en: 'Chianti Classico Wineries: Fèlsina, Agricola San Felice', zh: '经典基安蒂酒庄：Fèlsina、Agricola San Felice', image: 'https://source.unsplash.com/800x600/?chianti,wine,italy' },
      { en: 'Pienza: Renaissance "ideal city", pecorino cheese capital', zh: '皮恩扎：文艺复兴"理想城市"，羊奶酪之都', image: 'https://source.unsplash.com/800x600/?pienza,tuscany,italy' },
      { en: 'Montalcino: Brunello wine and fortress views', zh: '蒙塔尔奇诺：布鲁奈罗红酒和堡垒景观', image: 'https://source.unsplash.com/800x600/?montalcino,tuscany' },
      { en: 'Montepulciano: Vino Nobile wine and Renaissance architecture', zh: '蒙特普尔恰诺：贵族红酒和文艺复兴建筑', image: 'https://source.unsplash.com/800x600/?montepulciano,tuscany' },
      { en: 'Siena: Piazza del Campo, Duomo, medieval neighborhoods', zh: '锡耶纳：坎波广场、大教堂、中世纪街区', image: 'https://source.unsplash.com/800x600/?siena,tuscany,italy' },
      { en: 'Cortona: Etruscan hill town with panoramic views', zh: '科尔托纳：伊特鲁里亚山城，全景视野', image: 'https://source.unsplash.com/800x600/?cortona,tuscany' },
      { en: 'Medieval Festivals: Festa Medievale Bianco Azzurra, Maggiolata', zh: '中世纪节庆：Bianco Azzurra 节、Maggiolata 花卉节', image: 'https://source.unsplash.com/800x600/?medieval,festival,italy' },
    ],
  },
  {
    ...
    icon: '🏛️',
    items: [
      { en: 'Colosseum: Ancient amphitheater, easy-access routes available', zh: '斗兽场：古罗马圆形剧场，有轻松路线', image: 'https://source.unsplash.com/800x600/?colosseum,rome' },
      { en: 'Roman Forum: Ancient ruins with viewpoints', zh: '古罗马广场：古代遗址，有观景处', image: 'https://source.unsplash.com/800x600/?roman,forum,rome' },
      { en: 'Vatican: St. Peter\'s Basilica or Vatican Museums', zh: '梵蒂冈：圣彼得大教堂或梵蒂冈博物馆', image: 'https://source.unsplash.com/800x600/?vatican,st,peters' },
      { en: 'Trevi Fountain: Baroque masterpiece', zh: '特雷维喷泉：巴洛克杰作', image: 'https://source.unsplash.com/800x600/?trevi,fountain,rome' },
      { en: 'Spanish Steps: Iconic stairway', zh: '西班牙台阶：标志性阶梯', image: 'https://source.unsplash.com/800x600/?spanish,steps,rome' },
      { en: 'Pantheon: Ancient Roman temple', zh: '万神殿：古罗马神庙', image: 'https://source.unsplash.com/800x600/?pantheon,rome' },
      { en: 'Piazza Navona: Baroque square with fountains', zh: '纳沃纳广场：带喷泉的巴洛克广场', image: 'https://source.unsplash.com/800x600/?piazza,navona,rome' },
      { en: 'Trastevere: Charming neighborhood for evening strolls', zh: '特拉斯提弗列：适合傍晚散步的魅力街区', image: 'https://source.unsplash.com/800x600/?trastevere,rome' },
    ],
  },
  {
    ...
    icon: '🍝',
    items: [
      { en: 'Croatia: Fresh seafood, peka (slow-cooked meat), local wine', zh: '克罗地亚：新鲜海鲜、peka（慢炖肉）、当地葡萄酒', image: 'https://source.unsplash.com/800x600/?croatian,food,seafood' },
      { en: 'Italy: Regional pasta, pizza al taglio, gelato, aperitivo', zh: '意大利：地方特色意面、切块披萨、冰淇淋、开胃酒', image: 'https://source.unsplash.com/800x600/?italian,pasta,pizza' },
      { en: 'Tuscany: Chianti wine, pecorino cheese, cured meats', zh: '托斯卡纳：基安蒂红酒、羊奶酪、腌制肉类', image: 'https://source.unsplash.com/800x600/?tuscan,wine,cheese' },
      { en: 'Rome: Carbonara, cacio e pepe, supplì, Roman-style pizza', zh: '罗马：卡邦尼意面、黑胡椒奶酪意面、炸饭团、罗马式披萨', image: 'https://source.unsplash.com/800x600/?roman,carbonara,pasta' },
    ],
  },
];
