...
const croatiaCategories: ActivityCategory[] = [
  {
    ...
    icon: '🏛️',
    items: [
      { en: 'Dubrovnik Old Town: UNESCO walled city, cable car to Mt. Srđ', zh: '杜布罗夫尼克老城：联合国世界文化遗产，缆车上 Srđ 山', image: 'https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=800' },
      { en: 'Lokrum Island: Botanical gardens, peacocks, easy boardwalks', zh: '洛克鲁姆岛：植物园、孔雀、平缓木栈道', image: 'https://images.unsplash.com/photo-1508163223045-1880bc36e222?w=800' },
      { en: 'Split: Diocletian\'s Palace, Riva promenade', zh: '斯普利特：戴克里先宫、海滨长廊', image: 'https://images.unsplash.com/photo-1500375592092-40eb2168fd21?w=800' },
      { en: 'Krka National Park: Waterfalls, boat rides, easy walks', zh: '克尔卡国家公园：瀑布、游船、轻松步行', image: 'https://images.unsplash.com/photo-1508261306211-45a1c5c2a5c5?w=800' },
      { en: 'Hvar Island: Harbor town, beaches, lavender fields', zh: '赫瓦尔岛：港口小镇、海滩、薰衣草田', image: 'https://images.unsplash.com/photo-1533107862482-0e6974b06ec4?w=800' },
      { en: 'Zadar: Sea Organ, Greeting to the Sun, Roman forum', zh: '扎达尔：海风琴、向太阳致敬、古罗马广场', image: 'https://images.unsplash.com/photo-1518684079-3c830dcef090?w=800' },
      { en: 'Plitvice Lakes: UNESCO national park with lakes and waterfalls', zh: '普利特维采湖：联合国世界自然遗产，湖泊瀑布', image: 'https://images.unsplash.com/photo-1503650923300-dd2f6a007e77?w=800' },
    ],
  },
  {
    ...
    icon: '🏛️',
    items: [
      { en: 'St. Mark\'s Square & Basilica: Heart of Venice', zh: '圣马可广场和大教堂：威尼斯的心脏', image: 'https://images.unsplash.com/photo-1508672019048-805c876b67e2?w=800' },
      { en: 'Rialto Bridge: Iconic crossing over Grand Canal', zh: '里亚托桥：大运河上的标志性建筑', image: 'https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=800' },
      { en: 'Grand Canal Vaporetto: Scenic water bus ride', zh: '大运河水上巴士：风景优美的水上交通', image: 'https://images.unsplash.com/photo-1504981989411-2b18c3ca54d4?w=800' },
      { en: 'Arena di Verona: Ancient Roman amphitheater', zh: '维罗纳竞技场：古罗马圆形剧场', image: 'https://images.unsplash.com/photo-1582198625942-e71c175c1b7b?w=800' },
      { en: 'Juliet\'s House (Casa di Giulietta): Iconic balcony', zh: '朱丽叶之家（Casa di Giulietta）：经典阳台', image: 'https://images.unsplash.com/photo-1582198712494-1f8a4c2af9e3?w=800' },
    ],
  },
  {
    ...
    icon: '🍷',
    items: [
      { en: 'Chianti Classico Wineries: Fèlsina, Agricola San Felice', zh: '经典基安蒂酒庄：Fèlsina、Agricola San Felice', image: 'https://images.unsplash.com/photo-1504274066651-8d31a536b11a?w=800' },
      { en: 'Pienza: Renaissance "ideal city", pecorino cheese capital', zh: '皮恩扎：文艺复兴"理想城市"，羊奶酪之都', image: 'https://images.unsplash.com/photo-1516483638261-f4dbaf036963?w=800' },
      { en: 'Montalcino: Brunello wine and fortress views', zh: '蒙塔尔奇诺：布鲁奈罗红酒和堡垒景观', image: 'https://images.unsplash.com/photo-1525373698358-041e3a460346?w=800' },
      { en: 'Montepulciano: Vino Nobile wine and Renaissance architecture', zh: '蒙特普尔恰诺：贵族红酒和文艺复兴建筑', image: 'https://images.unsplash.com/photo-1520174691701-bc555a3404ca?w=800' },
      { en: 'Siena: Piazza del Campo, Duomo, medieval neighborhoods', zh: '锡耶纳：坎波广场、大教堂、中世纪街区', image: 'https://images.unsplash.com/photo-1506157786151-b8491531f063?w=800' },
      { en: 'Cortona: Etruscan hill town with panoramic views', zh: '科尔托纳：伊特鲁里亚山城，全景视野', image: 'https://images.unsplash.com/photo-1549898585-350b93c9e4f1?w=800' },
      { en: 'Medieval Festivals: Festa Medievale Bianco Azzurra, Maggiolata', zh: '中世纪节庆：Bianco Azzurra 节、Maggiolata 花卉节', image: 'https://images.unsplash.com/photo-1544989164-31dc3c645987?w=800' },
    ],
  },
  {
    ...
    icon: '🏛️',
    items: [
      { en: 'Colosseum: Ancient amphitheater, easy-access routes available', zh: '斗兽场：古罗马圆形剧场，有轻松路线', image: 'https://images.unsplash.com/photo-1513475382585-d06e58bcb0ea?w=800' },
      { en: 'Roman Forum: Ancient ruins with viewpoints', zh: '古罗马广场：古代遗址，有观景处', image: 'https://images.unsplash.com/photo-1534258936925-c58bed479fcb?w=800' },
      { en: 'Vatican: St. Peter\'s Basilica or Vatican Museums', zh: '梵蒂冈：圣彼得大教堂或梵蒂冈博物馆', image: 'https://images.unsplash.com/photo-1518639192441-8fce0a366e2a?w=800' },
      { en: 'Trevi Fountain: Baroque masterpiece', zh: '特雷维喷泉：巴洛克杰作', image: 'https://images.unsplash.com/photo-1515023115689-589c33041d3c?w=800' },
      { en: 'Spanish Steps: Iconic stairway', zh: '西班牙台阶：标志性阶梯', image: 'https://images.unsplash.com/photo-1521207418485-99c705420785?w=800' },
      { en: 'Pantheon: Ancient Roman temple', zh: '万神殿：古罗马神庙', image: 'https://images.unsplash.com/photo-1542382257-80dedb725088?w=800' },
      { en: 'Piazza Navona: Baroque square with fountains', zh: '纳沃纳广场：带喷泉的巴洛克广场', image: 'https://images.unsplash.com/photo-1530038226560-00e1604e0df5?w=800' },
      { en: 'Trastevere: Charming neighborhood for evening strolls', zh: '特拉斯提弗列：适合傍晚散步的魅力街区', image: 'https://images.unsplash.com/photo-1526129318478-62ed807ebdf9?w=800' },
    ],
  },
  {
    ...
    icon: '🍝',
    items: [
      { en: 'Croatia: Fresh seafood, peka (slow-cooked meat), local wine', zh: '克罗地亚：新鲜海鲜、peka（慢炖肉）、当地葡萄酒', image: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800' },
      { en: 'Italy: Regional pasta, pizza al taglio, gelato, aperitivo', zh: '意大利：地方特色意面、切块披萨、冰淇淋、开胃酒', image: 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?w=800' },
      { en: 'Tuscany: Chianti wine, pecorino cheese, cured meats', zh: '托斯卡纳：基安蒂红酒、羊奶酪、腌制肉类', image: 'https://images.unsplash.com/photo-1451847251646-8a6c0dd1510c?w=800' },
      { en: 'Rome: Carbonara, cacio e pepe, supplì, Roman-style pizza', zh: '罗马：卡邦尼意面、黑胡椒奶酪意面、炸饭团、罗马式披萨', image: 'https://images.unsplash.com/photo-1540136186085-4c4e4e8b0535?w=800' },
    ],
  },
];
...
const chinaCategories: ActivityCategory[] = [
  {
    ...
    icon: '🏛️',
    items: [
      { en: 'Forbidden City: Imperial palace, slow thorough visit', zh: '故宫：皇宫，缓慢深入参观', image: 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?w=800' },
      { en: 'Great Wall (Mutianyu): Less crowded than Badaling', zh: '长城（慕田峪）：比八达岭人少', image: 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?w=800' },
      { en: 'Jingshan Park: Panorama over palace roofs', zh: '景山公园：宫殿屋顶全景', image: 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?w=800' },
      { en: 'Hutongs: Traditional alleyways near Wangfujing', zh: '胡同：王府井附近传统小巷', image: 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?w=800' },
      { en: 'Tanzhe Temple: Ancient mountain temple, few tourists', zh: '潭柘寺：古老山寺，游客稀少', image: 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?w=800' },
    ],
  },
  {
    ...
    icon: '🌾',
    items: [
      { en: 'Inner Mongolia Museum: Dinosaurs + nomadic culture', zh: '内蒙古博物院：恐龙+游牧文化', image: 'https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=800' },
      { en: 'Da Zhao Temple: Historic Buddhist temple', zh: '大召寺：历史悠久的佛教寺庙', image: 'https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=800' },
      { en: 'General\'s Mansion: Qing military HQ', zh: '将军衙署：清代军事总部', image: 'https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=800' },
      { en: 'Ordos Desert: Seven Star Lake dunes, camel rides', zh: '鄂尔多斯沙漠：七星湖沙丘、骑骆驼', image: 'https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=800' },
      { en: 'Mongolian cuisine: Milk tea, stew, roast lamb', zh: '蒙古美食：奶茶、炖菜、烤羊肉', image: 'https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=800' },
    ],
  },
];
